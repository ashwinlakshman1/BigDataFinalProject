package com.ashwin.frequent_weapons;
...
public class FreqWeaponReducer extends Reducer<Text, LongWritable, LongWritable, Text> {
    ...
    public void cleanup(Context context) throws IOException,
        ...
        for (Map.Entry<Long, String> entry : tmap2.entrySet()) {
            ...
            context.write(new LongWritable(count), new Text(weapon_name));
        }
    }
}
